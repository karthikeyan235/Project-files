...
INSERT INTO `accounts_profile` VALUES (1,NULL,'admin','1',1),(2,'3454345348','parent','111',2),(3,NULL,'parent','2',3),(4,NULL,'teacher','123',4),(5,'3456789345','parent','123456,2345',5);
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$600000$AaQqkUKjZYOPeYcPPEsOze$X9LRvXgmBZgjJVgeofEVoSjDh2PYkSxkDs+yzIpo2D8=','2023-09-11 06:50:57.462670',1,'sachin','','','',1,1,'2023-09-06 12:16:05.829487'),(2,'pbkdf2_sha256$260000$3lEU17Vlq8ozRpGAkcXQ8U$nDL89D4KTpz06st3wFbbbpJWPmVqg/oYfg8YiMgf/Qw=','2023-09-07 06:07:13.530308',0,'3454345348','SACHIN','','sa@dd.com',0,1,'2023-09-06 12:51:41.810345'),(3,'pbkdf2_sha256$600000$nWrEJWTtYx0MUBgFmCpqvc$jwuRsBrKjTXji0ush/jujF6UqBZ2eHjXMSzp0xn28dA=','2023-09-09 05:17:47.581421',0,'sai','','','',1,1,'2023-09-07 06:01:22.000000'),(4,'pbkdf2_sha256$260000$ErKhJzYnXcMuIiCt06z1xu$LYjcwI2UqxSQTfiEfHu2Oy8AP2yHqFexpnOE8u4mtQQ=','2023-09-11 05:05:21.646982',1,'giri','','','',1,1,'2023-09-07 07:05:12.362412'),(5,'pbkdf2_sha256$260000$KE7TyLIzmLzXlvin4nrput$F4inL3k+1G+DiBPJRtzgKjfbU23jV1e+44404yjCZJ4=',NULL,0,'3456789345','SANJAY','','sa@dd.com',0,1,'2023-09-07 10:54:53.404649');
...
INSERT INTO `tbl_classsections` VALUES (1,1,'A'),(2,2,'A'),(3,3,'B'),(4,2,'B');
...
INSERT INTO `tblattendance_111` VALUES ('2023-09-11',0,1,1,0,0,0);
...
INSERT INTO `tblattendance_123456` VALUES ('2023-09-11',0,1,1,0,0,0);
...
INSERT INTO `tblattendance_2345` VALUES ('2023-09-11',1,1,1,0,0,0);
...
BEGIN
	...
	WHILE i < n DO
		...
		IF @exists = 'BASE TABLE' THEN
            ...
            EXECUTE stmt;
            DEALLOCATE PREPARE stmt;
            SET result =  CONCAT(result,@p1,',',@p2,',',@p3,',',@p4,',',@p5,',',@p6,',');
		END IF;
		SET i = i+1;
    END WHILE;
	SELECT result;
...
-- Dump completed on 2023-09-11 13:15:26
